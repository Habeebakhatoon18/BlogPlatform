...
export default function SearchDialog() {
    ...
    return (
        <Fragment>
            ...
            {/* Dialog  */}
            <Dialog className=" flex justify-center  items-center fixed inset-0 w-[25em] h-[18em] md:h-[25em] m-auto mt-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* Dialog Body  */}
                <DialogBody  >
                    ...
                    <div className="flex justify-center flex-wrap sm:mx-auto sm:mb-2 -mx-2 mt-4 mb-2">
                        {
                            getAllBlog.filter((obj) => obj.title.toLowerCase().includes(searchkey)).map((item, index) => {
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-400">Powered By Tech Diva</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
